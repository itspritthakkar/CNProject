...
function showAppointmentForm() {
    $("#continue-btn").hide();
    $("#appointmentFields").css("visibility", "")
}
...
$("#loginForm").submit(function(e) {
    ...
    $.ajax({
           ...
           {
               if (data.status == 'failed') {
                   if(data.type == 'credentialerror') {
                        $("#errorCallback").removeClass();
                        $("#errorCallback").addClass( "text-danger" );
                        $("#errorCallback").text(data.msg);
                   }
               } else if(data.status == 'success'){
                    $("#errorCallback").removeClass();
                    $("#errorCallback").addClass( "text-success" );
                    $("#errorCallback").text(data.msg);
